<template>
  <div class="cl-date-range-picker" style="border: 1px solid red;" ref="wrapper">
    <cl-popover ref="popover" position="bottom" :container="popoverContainer" @open="onOpen">
      ...
      <template slot="content">
        <div :class="c('pop')" @selectstart.prevent>
          <div :class="c('pickers')">
            <div :class="c('picker1')">
              <div class="cl-date-range-picker-nav">
              ...
              <div class="cl-date-range-picker-panels">
                <div class="cl-date-range-picker-content">
          ...
          <div class="cl-date-range-picker-actions">
...
export default {
  ...
  methods: {
    c(...classNames) {
      return classNames.map(className => `cl-date-range-picker-${className}`);
    },
    onInput(value) {
